...
def fetch_trainings(iulaan_type=config.IULAAN_TYPES['training'], description=None):
    rep = []
    page = 1
    while page < 5:
...
if __name__ == "__main__":
    ...
    post_iulaan_queue(fetch_trainings())  # all jobs in "information technology category"
